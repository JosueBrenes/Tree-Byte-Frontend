  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto p-6 rounded-xl">
        ...
        {/* Stats */}
        <div className="flex justify-between border-y py-4 mb-6">
          ...
          <div>
            <p className="text-sm text-black font-medium">Annual Impact:</p>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          {/* About */}
          <div>
            <h3 className="font-semibold text-black text-base flex items-center gap-2 mb-2">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          {/* Activities */}
          <div>
            <p className="text-black font-medium text-sm mb-2">Activities:</p>
            <div className="flex flex-wrap gap-2">
              {project.activities.map((activity, index) => (
                <span
                  key={index}
                  className="bg-gray-200 px-3 py-1 rounded-full text-sm text-black"
                >
                  {activity}
                </span>
              ))}
        ...
        <div className="flex gap-4">
          <Button
            variant="outline"
            className="flex-1 border border-[#7EF45D] text-black bg-[#DFFFD4] hover:bg-[#caf8be]"
          >
            Need information?
          </Button>
